<template>
	<view class="flex flexjc flexac" style="padding-bottom: 180rpx;">
		<view class="flex flexcol inItemWrap" style="margin-top: 20rpx;">
			<view class="inItemHis flex flexrow flexac flexsb" v-for="(item,index) in 15" :key="index">
				<view class="flex flexrow flexac">
					<image src="https://leyu-demo.xinhualeyu.com/oc3.png" class="flexf" style="width:80rpx;height: 80rpx;border-radius: 100%;margin-right: 22rpx;"></image>
